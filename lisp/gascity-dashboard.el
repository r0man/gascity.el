...
stores this view targets).  EVENTS-LOAD is the normalized JSONL events
load; EVENT-TYPES-EXCLUDED the Activity feed's excluded types (root
state, survives a refresh).  COLLAPSED is the root's
